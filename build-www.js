...
const FILES = ['index.html', 'style.css', 'app.js', 'board.js', 'floorplan.js', 'logic-engine.js', 'story.js', 'themes.js',
  'campaign.js', 'progress.js', 'mentor.js', 'mapart.js', 'minigame.js', 'store.js', 'sound.js', 'avatars.js', 'manifest.json', 'sw.js', 'icon-192.png', 'icon-512.png', 'privacy.html', 'support.html'];
